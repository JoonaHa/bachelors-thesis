...
%%  Language: 
%%      finnish, swedish, or enyliopiston virkanimikkeetglish
...
\supervisors{Vanhenpi yliopiston lehtori~Lea Kutvonen}
\examiners{Prof.~D.U.~Mind, Dr.~O.~Why}


\keywords{järjestelmäintegraatiot, EAI, sanomat, suunnittelumallit, arkkitehtuuri, EIP}
...
\ Applied computing $\rightarrow$ Enterprise computing $\rightarrow$ Enterprise interoperability $\rightarrow$ Enterprise application integration\ \\
\ Software and its engineering $\rightarrow$ Software organization and properties $\rightarrow$ Contextual software domains $\rightarrow$ Operating systems $\rightarrow$ Communications management $\rightarrow$ Message passing
}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Do not overflow urls in bibliography
