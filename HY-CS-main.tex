...
%%  -> you can use, e.g., \citep{} or \parencite{} for (Einstein, 1905); with APA \cite -> Einstein, 1905 without ()
...
\title{Järjestelmäintegraatioiden tyylit ja suunnittelumallit nykypäivänä}
