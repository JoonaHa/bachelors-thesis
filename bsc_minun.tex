...
\newpage
\begin{center}
    \begin{tabular}{ |p{0.19\textwidth}|p{0.15\textwidth}|p{0.2\textwidth}|p{0.15\textwidth}|p{0.15\textwidth}|}
    \hline
    Suunnittelumalli & Tuki & Tilallinen/Tilaton & Modernisoitu & Formalisointi \\ \hline
    Jakaja \textit{(Splitter)} &
      ...
      &
        \begin{itemize}
           \item DB-net formalisointi esimerkki \citep{Ritter2021}.
        \end{itemize}
    \\ \hline
    Sanomakääntäjä \textit{(Message Translator)} & 
      ...
      &
        \begin{itemize}
            \item Tilaton. Kääntäjä kääntää vain yhden sanoman sisällön eikä säilytä tilaa.
        \end{itemize}
      &
        \begin{itemize}
            \item Ei
    ...
    Sisältöpohjainen reititin \textit{(Content Based Router)} & 
      ...
      &
        \begin{itemize}
            \item Tilaton. Reititin ei muista aikaisempi sanomia.
        \end{itemize}
      &
        \begin{itemize}
    ...
    Sisällön rikastaja \textit{(Content Enricher)} & 
      ...
      &
        \begin{itemize}
            \item Tilaton. Rikastaja ei muista aikaisempia sanomia.
        \end{itemize}
      &
        \begin{itemize}
    ...
    Sisältösuodatin \textit{(Content Filter)} & 
      &
        ...
        \end{itemize}
        \begin{itemize}
            \item Tilaton. Suodatin suodattaa vain yksittäisen sanoman sisältöä.
        \end{itemize}
      &
        \begin{itemize}
            \item Ei
