...
Vaikka EAI-järjestelmiä löytyy monenlaisia, kaupallisia sekä avoimen lähdekoodin ratkaisuja
Tästä huolimatta useimpien ratkaisujen lähetysmistavat muistuttavat toisiaan ja 
